...
public class BTSearchPlayerv02 : BTnode
{
    public override IEnumerator Run(BehaviorTree bt)
    {
        ...
        {
            SeePlayer = bt.gameObject.GetComponent<BTEnemyCAceteteV01>().SeePlayer;
            npc.transform.localEulerAngles = new Vector3(0, bt.gameObject.GetComponent<BTEnemyCAceteteV01>().Yrotation, 0);
